...
export default function AdminSettingsClient() {
  ...
  const [activeTab, setActiveTab] = useState<"financial" | "shipping" | "promos" | "inventory" | "contact">("promos");
    ...
    <div className="min-h-screen bg-[#f8f8f8] py-8 px-4 sm:px-8 space-y-8 max-w-[1520px] mx-auto">
      ...
      <div className="flex border-b border-neutral-200 overflow-x-auto gap-2">
        <button
          ...
          className={`px-4 py-3 text-xs font-bold uppercase tracking-wider border-b-2 flex items-center gap-2 transition-colors whitespace-nowrap ${
            activeTab === "promos"
      ...
      {isAddPromoOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-white max-w-lg w-full p-6 border border-neutral-300 shadow-xl space-y-6">
